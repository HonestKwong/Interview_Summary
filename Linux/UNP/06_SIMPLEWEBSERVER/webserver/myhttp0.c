/***********************************************************
  ...
  > Created Time: 2021年02月20日 星期六 13时16分21秒
    > Modified Time:2021年02月20日 星期六 14时08分32秒
 *******************************************************/
...
void do_accept(int lfd, int epfd)
{
    ...
    socklen_c clt_addr_len = sizeof(clt_addr);

    int cfd = accept(lfd, (strcut sockaddr*)&clt_addr, &clt_addr_len);
